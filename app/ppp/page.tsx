    ...
    <div className="min-h-screen bg-slate-900 text-white">
          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Convierte el poder de la inteligencia artificial en tu negocio y genera ingresos desde el primer día con
                una plataforma White Label bajo tu marca.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/registro?plan=ppp">
                  ...
                  <div className="relative z-10 p-6 h-full flex flex-col">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-white/80 text-sm">
                        Introduzca cualquier texto para crear anuncios relevantes en más de 40 idiomas.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 flex-1">
                      {[
                        ...
                        <div
                          key={index}
                          className="bg-white/10 backdrop-blur-sm rounded-lg p-2 border border-white/20 relative"
                        >
      ...
      <section className="px-6 py-20 bg-gradient-to-b from-slate-900 to-slate-800">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Con nuestra solución White Label de Advento STARTER tendrás una plataforma{" "}
            <strong className="text-white">todo-en-uno</strong> para vender marketing bajo tu marca.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              <span className="text-green-400">✅</span>
              <div>
                <strong className="text-white">Tu marca, tu dominio</strong>
                <br />
            ...
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              <span className="text-green-400">✅</span>
              <div>
                <strong className="text-white">Definir precios</strong>
                <br />
            ...
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              <span className="text-green-400">✅</span>
              <div>
                <strong className="text-white">Sin técnico</strong>
                <br />
            ...
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              <span className="text-green-400">✅</span>
              <div>
                <strong className="text-white">Todo en un lugar</strong>
                <br />
      ...
      <section className="px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Todo lo necesario para vender como una agencia profesional desde el día uno.
          </p>
      ...
      <section className="px-6 py-20 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-2xl text-gray-300 mb-8">
            Tú decides cuánto cobrar. Con márgenes de hasta el <strong className="text-yellow-400 text-3xl">98%</strong>
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              ...
              <div>
                <strong className="text-white">Freelancers</strong>
                <br />
            ...
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              <span className="text-2xl">🏢</span>
              <div>
                <strong className="text-white">Agencias</strong>
                <br />
            ...
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              <span className="text-2xl">💼</span>
              <div>
                <strong className="text-white">Emprendedores</strong>
                <br />
            ...
            <div className="flex gap-3 items-start bg-gray-800/90 border border-white/20 rounded-xl p-4">
              <span className="text-2xl">📣</span>
              <div>
                <strong className="text-white">Creadores</strong>
                <br />
      ...
      <section className="px-6 py-20 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-300">
            <em>
              "Advento es como tener un equipo de marketing completo, funcionando 24/7 por ti… y por tus clientes."
            </em>{" "}
            Ahora puedes revender esa potencia <strong className="text-yellow-400">bajo tu marca</strong>.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-br from-yellow-500/10 to-green-500/10 rounded-3xl p-12 border border-yellow-500/20">
            <Badge className="bg-yellow-400/20 text-yellow-400 border-yellow-400/30 mb-6 px-6 py-3 text-lg">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent className="p-6">
                <details>
                  ...
                  <p className="text-gray-300">
                    No. La plataforma llega lista y nosotros te apoyamos con el set-up inicial.
                  </p>
                </details>
              </CardContent>
            </Card>
            <Card className="bg-gray-800/90 border-white/20">
              <CardContent className="p-6">
                <details>
                  <summary className="cursor-pointer font-bold text-white mb-3">
                    ¿Puedo poner mi dominio y logo?
                  </summary>
            ...
            <Card className="bg-gray-800/90 border-white/20">
              <CardContent className="p-6">
                <details>
                  <summary className="cursor-pointer font-bold text-white mb-3">
                    ¿Puedo escalar a muchos clientes?
                  </summary>
